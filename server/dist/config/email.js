...
class EmailService {
    ...
    async sendContactConfirmation(name, email, message) {
    ...
    async sendNewContactNotification(name, email, message, ipAddress) {
    ...
    getContactConfirmationTemplate(name, message) {
        return `
      <!DOCTYPE html>
      <html>
      <head>
    ...
    getNewContactNotificationTemplate(name, email, message, ipAddress) {
        return `
      <!DOCTYPE html>
      <html>
      <head>
